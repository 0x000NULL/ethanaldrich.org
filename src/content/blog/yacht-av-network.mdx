...
description: "Networking and AV for two vessels on a single visit each: dual Starlink with failover, a segmented UniFi estate, Control4 integration, and what a salt-air environment does to assumptions you would never question ashore."
author: "Ethan Aldrich"
tags: ["networking", "unifi", "av", "starlink"]
---

### Table of Contents
1. [Introduction & Project Overview](#1-introduction--project-overview)
2. [The Vessels](#2-the-vessels)
3. [Dual-Starlink Configuration Strategy](#3-dual-starlink-configuration-strategy)
4. [UniFi Network Infrastructure](#4-unifi-network-infrastructure)
5. [VLAN Architecture & Network Segmentation](#5-vlan-architecture--network-segmentation)
6. [Control4 AV System Integration](#6-control4-av-system-integration)
7. [Marine Environment Challenges](#7-marine-environment-challenges)
8. [Cable Routing & Infrastructure](#8-cable-routing--infrastructure)
9. [Control4 + UniFi Integration Details](#9-control4--unifi-integration-details)
10. [Lessons Learned & Recommendations](#10-lessons-learned--recommendations)
